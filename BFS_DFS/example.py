...
————————————————
版权声明：本文为CSDN博主「Paper_Yu」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/weixin_40314737/article/details/80893507
...
class Solution(object):
    ...
    def getRandom(self):
        ...
        while cur.next:
            cur = cur.next
            cur_size += 1
            if random.randint(1, cur_size) % cur_size == 0:
                button = cur.val
        return button